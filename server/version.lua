...
local resourceName = "hw_containerrobbery"

if Config.checkForUpdates then
    CreateThread(function()
        if GetCurrentResourceName() ~= "hw_containerrobbery" then
            resourceName = "hw_containerrobbery (" .. GetCurrentResourceName() .. ")"
        end
    end)

    CreateThread(function()
        while true do
            PerformHttpRequest("https://api.github.com/repos/HenkW00/hw_containerrobbery/releases/latest", CheckVersion, "GET")
            Wait(3500000)
        end
    end)
    ...
    GetRepoInformations = function()
        ...
        PerformHttpRequest("https://api.github.com/repos/HenkW00/hw_containerrobbery/releases/latest", function(err, response, headers)
            if err == 200 then
                ...
                repoURL = "https://github.com/HenkW00/hw_containerrobbery"
...
AddEventHandler('onResourceStart', function(resourceName)
    ...
    print('^7> ^5[HW Scripts] ^7| ^4Discord Server Link: ^3https://discord.com/invite/buqhWxVYkQ')
    print('^7> ================================================================')
end)
